...
for (const vp of WIDTHS) {
  // BUG N-38: below ~1180px of bar width the TopBar drops the center slot
  // (logline pill) onto its own line so the right cluster (version chip +
  // ⋯ actions) can never cover it — all three widths exercise the full
  // pill-click → popover-in-viewport contract.
