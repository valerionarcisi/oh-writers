 ...
 *
 * [OHW-039e-a] Locations page: read_scene skill is active — Cesare calls
 *   read_scene when asked about a scene.
 *
 * [OHW-039e-b] Breakdown page: budget tools are NOT present — the mock
...
test.describe("[Spec 39] Cesare V2 — skill isolation", () => {
  test(
    "[OHW-039e-a] Locations page uses read_scene tool when asked about a scene",
  ...
  test(
    "[OHW-039e-b] Breakdown page does not expose budget tools",
    async ({ authenticatedPage }) => {
