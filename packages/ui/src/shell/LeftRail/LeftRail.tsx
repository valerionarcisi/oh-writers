...
export type LeftRailProps = {
  ...
  /** Cesare sessions — when provided, the rail surfaces a "Sessioni Cesare"
   *  section above the primary nav (Notion-style "Recents" pattern). The
   *  section is visible regardless of Cesare state, so users can jump back
   *  into any past chat thread from anywhere in the app. */
...
export function LeftRail({
  ...
  return (
    ...
    >
      ...
      {/* Sessions slot — always rendered when at least one session exists. */}
