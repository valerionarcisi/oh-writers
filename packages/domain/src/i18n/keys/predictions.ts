...
export const predictionsKeys = {
  en: {
    ...
    "cesare.editorial.details": "Editorial details",
    "cesare.editorial.whyItMatters": "Why it matters",
    "cesare.editorial.whenToIgnore": "When to ignore it",
    "cesare.editorial.minimalIntervention": "Minimal intervention",
    "cesare.editorial.explore": "Explore",
    "cesare.editorial.apply": "Apply",
    "cesare.editorial.mark": "Mark",
    "cesare.editorial.actionsMenuLabel": "Open editorial actions",
    "cesare.editorial.actionsMenuTitle": "Open editorial actions",
    "cesare.editorial.markAuthorialChoice": "Authorial choice",
    "cesare.editorial.markAuthorialChoiceHint":
      "Hides this note and treats it as intentional.",
    "cesare.editorial.resolve": "Area resolved",
    "cesare.editorial.resolveHint":
      "Marks this point as already handled in the current revision.",
    "cesare.editorial.approve": "Editorial OK",
    "cesare.editorial.approveHint": "Closes the note as sufficiently resolved.",
    "cesare.editorial.ignore": "Ignore",
    "cesare.editorial.ignoreHint":
      "Removes this suggestion from the current cycle.",
    "cesare.editorial.priorityTitle": "Editorial priorities",
    "cesare.editorial.stateTitle": "Editorial state",
    "cesare.editorial.stateHint": "Cesare knows when to stop.",
    "cesare.editorial.optionalTitle": "Optional fine tuning",
    "cesare.editorial.optionalHint": "Taste-level edits or micro refinements.",
    "cesare.editorial.type.real_problem": "Real problem",
    "cesare.editorial.type.risk": "Risk",
    "cesare.editorial.type.authorial_choice": "Authorial choice",
    "cesare.editorial.type.optional": "Fine tuning",
    "cesare.editorial.type.already_resolved": "Already resolved enough",
    "cesare.editorial.type.approved": "Editorial OK",
    "cesare.editorial.severity.high": "High",
    "cesare.editorial.severity.medium": "Medium",
    "cesare.editorial.severity.low": "Low",
    "cesare.editorial.severity.optional": "Optional",
    "cesare.editorial.status.open": "Open",
    "cesare.editorial.status.ignored": "Ignored",
    "cesare.editorial.status.authorial_choice": "Authorial choice",
    "cesare.editorial.status.resolved": "Resolved",
    "cesare.editorial.status.approved": "Approved",
    "cesare.editorial.area.structure": "Structure",
    "cesare.editorial.area.clarity": "Clarity",
    "cesare.editorial.area.tone": "Tone",
    "cesare.editorial.area.rhythm": "Rhythm",
    "cesare.editorial.area.character": "Characters",
    "cesare.editorial.area.theme": "Theme",
    "cesare.editorial.area.ending": "Ending",
    "cesare.editorial.area.format": "Format",
    "cesare.editorial.area.logline": "Logline",
    "cesare.editorial.area.synopsis": "Synopsis",
    "cesare.editorial.area.subject": "Subject",
    "cesare.editorial.area.outline": "Outline",
    "cesare.editorial.area.treatment": "Treatment",
    "cesare.editorial.area.screenplay": "Screenplay",
    "cesare.editorial.area.dialogue": "Dialogue",
    "cesare.editorial.area.action": "Action",
    "cesare.editorial.area.pacing": "Pacing",
    "cesare.editorial.area.style": "Style",
    "cesare.editorial.area.scene": "Scene",
  },
  it: {
    // Page label chips (uppercase, used in Cesare context tags + empty state)
    ...
    "cesare.editorial.details": "Dettagli editoriali",
    "cesare.editorial.whyItMatters": "Perché conta",
    "cesare.editorial.whenToIgnore": "Quando ignorarlo",
    "cesare.editorial.minimalIntervention": "Intervento minimo",
    "cesare.editorial.explore": "Approfondisci",
    "cesare.editorial.apply": "Applica",
    "cesare.editorial.mark": "Segna",
    "cesare.editorial.actionsMenuLabel": "Apri azioni editoriali",
    "cesare.editorial.actionsMenuTitle": "Apri azioni editoriali",
    "cesare.editorial.markAuthorialChoice": "Scelta autoriale",
    "cesare.editorial.markAuthorialChoiceHint":
      "Nasconde questo punto e lo considera intenzionale.",
    "cesare.editorial.resolve": "Area risolta",
    "cesare.editorial.resolveHint":
      "Segna il punto come già sistemato in questa revisione.",
    "cesare.editorial.approve": "OK editoriale",
    "cesare.editorial.approveHint": "Chiude la nota come abbastanza risolta.",
    "cesare.editorial.ignore": "Ignora",
    "cesare.editorial.ignoreHint":
      "Rimuove questo consiglio dal ciclo corrente.",
    "cesare.editorial.priorityTitle": "Priorità editoriali",
    "cesare.editorial.stateTitle": "Stato editoriale",
    "cesare.editorial.stateHint": "Cesare sa fermarsi.",
    "cesare.editorial.optionalTitle": "Fine tuning opzionale",
    "cesare.editorial.optionalHint": "Interventi di gusto o micro-rifiniture.",
    "cesare.editorial.type.real_problem": "Problema reale",
    "cesare.editorial.type.risk": "Rischio",
    "cesare.editorial.type.authorial_choice": "Scelta autoriale",
    "cesare.editorial.type.optional": "Fine tuning",
    "cesare.editorial.type.already_resolved": "Già abbastanza risolto",
    "cesare.editorial.type.approved": "OK editoriale",
    "cesare.editorial.severity.high": "Alta",
    "cesare.editorial.severity.medium": "Media",
    "cesare.editorial.severity.low": "Bassa",
    "cesare.editorial.severity.optional": "Opzionale",
    "cesare.editorial.status.open": "Aperto",
    "cesare.editorial.status.ignored": "Ignorato",
    "cesare.editorial.status.authorial_choice": "Scelta autoriale",
    "cesare.editorial.status.resolved": "Risolto",
    "cesare.editorial.status.approved": "Approvata",
    "cesare.editorial.area.structure": "Struttura",
    "cesare.editorial.area.clarity": "Chiarezza",
    "cesare.editorial.area.tone": "Tono",
    "cesare.editorial.area.rhythm": "Ritmo",
    "cesare.editorial.area.character": "Personaggi",
    "cesare.editorial.area.theme": "Tema",
    "cesare.editorial.area.ending": "Finale",
    "cesare.editorial.area.format": "Formato",
    "cesare.editorial.area.logline": "Logline",
    "cesare.editorial.area.synopsis": "Sinossi",
    "cesare.editorial.area.subject": "Soggetto",
    "cesare.editorial.area.outline": "Scaletta",
    "cesare.editorial.area.treatment": "Trattamento",
    "cesare.editorial.area.screenplay": "Sceneggiatura",
    "cesare.editorial.area.dialogue": "Dialoghi",
    "cesare.editorial.area.action": "Azione",
    "cesare.editorial.area.pacing": "Ritmo",
    "cesare.editorial.area.style": "Stile",
    "cesare.editorial.area.scene": "Scena",
  },
