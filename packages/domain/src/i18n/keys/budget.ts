...
export const budgetKeys = {
  en: {
    ...
    "budget.flat.confirmRemoveTitle": "Remove line",
    "budget.flat.confirmRemoveAction": "Remove",
  ...
  it: {
    ...
    "budget.flat.confirmRemoveTitle": "Rimuovi voce",
    "budget.flat.confirmRemoveAction": "Rimuovi",
