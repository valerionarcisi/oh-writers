...
const ITALIAN_IMPERATIVE_REGEX =
  /\b(aggiungi|aggiungere|modifica|modificare|crea|creare|rinomina|rinominare|applica|applicare|salva|salvare|rimuovi|rimuovere|sposta|spostare|sostituisci|sostituire|elimina|eliminare|genera|generare|imposta|impostare|cambia|cambiare|togli|togliere|metti|mettere|fai|costruisci|costruire|riscrivi|riscrivere|aggiorna|aggiornare|cancella|cancellare|propaga|propagare|distribuisci|distribuire|sincronizza|sincronizzare|esegui|eseguire|trova|trovare|cerca|cercare|espandi|espandere|comprimi|comprimere|accorcia|accorciare|riassumi|riassumere|tagga|taggare|spoglia|spogliare|riduci|ridurre|abbassa|abbassare|alza|alzare|aumenta|aumentare|riallocara|rialloca|riallocare|redistribuisci|redistribuire)\b/i;
