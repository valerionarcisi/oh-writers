...
> **Note**: shell-level UX is now governed by [Spec 44](../44-shell-refactor-notion-style.md). This spec's recommendations remain authoritative for react-aria hook usage but defer to Spec 44 for AppShell layout decisions.
